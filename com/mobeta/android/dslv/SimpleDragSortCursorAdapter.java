            ...
            if (v != null) {
                ...
                if (bound) {
                    ...
                    if (v instanceof TextView) {
                        ...
                        throw new IllegalStateException(new StringBuilder(String.valueOf(v.getClass().getName())).append(" is not a ").append(" view that can be bounds by this SimpleCursorAdapter").toString());
                    }
                }
            }
        }

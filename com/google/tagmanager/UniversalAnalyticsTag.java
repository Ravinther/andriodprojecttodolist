...
class UniversalAnalyticsTag extends TrackingTag {
    ...
    public void evaluateTrackingTag(Map<String, Value> tag) {
        ...
        if (checkBooleanProperty(tag, ANALYTICS_PASS_THROUGH)) {
            ...
            Log.m1395w("Ignoring unknown tag.");
        }
    ...
    private void sendTransaction(Tracker tracker, Map<String, Value> tag) {
        ...
        if (transactionId == null) {
            Log.m1389e("Cannot find transactionId in data layer.");
            return;
        }
        ...
        try {
            ...
            if (items != null) {
                for (Map<String, String> item : items) {
                    if (item.get("name") == null) {
                        Log.m1389e("Unable to send transaction item hit due to missing 'name' field.");
                        return;
                    }
            ...
            Log.m1390e("Unable to send transaction", e);
        }
    }

...
public class ContainerOpener {
    ...
    /* renamed from: com.google.tagmanager.ContainerOpener.3 */
    class C04333 extends TimerTask {
        C04333() {
        }

        public void run() {
            Log.m1391i("Timer expired.");
    ...
    /* renamed from: com.google.tagmanager.ContainerOpener.1 */
    class C08141 implements Clock {
        C08141() {
        }
    ...
    static class C08152 implements Notifier {
        final /* synthetic */ ContainerFutureImpl val$future;

        C08152(ContainerFutureImpl containerFutureImpl) {
    ...
    public static ContainerFuture openContainer(TagManager tagManager, String containerId, OpenType openType, Long timeoutInMillis) {
        ...
        openContainer(tagManager, containerId, openType, timeoutInMillis, new C08152(future));
        return future;
    }
    ...
    private void setTimer(long timeoutInMillis) {
        new Timer("ContainerOpener").schedule(new C04333(), timeoutInMillis);
    }

...
class CtfeHost {
    ...
    public CtfeHost() {
        this.mCtfeServerAddress = CTFE_SERVER_ADDRESS;
    }

    public void setCtfeServerAddress(String newCtfeAddress) {
        this.mCtfeServerAddress = newCtfeAddress;
        Log.m1391i("The Ctfe server endpoint was changed to: " + newCtfeAddress);
    }
    ...
    String constructCtfeDebugUrl(int currentEventNumber) {

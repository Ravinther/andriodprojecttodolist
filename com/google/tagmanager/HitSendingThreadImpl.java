...
class HitSendingThreadImpl extends Thread implements HitSendingThread {
    ...
    class C04341 implements Runnable {
        ...
        C04341(HitSendingThread hitSendingThread, long j, String str) {
    ...
    void sendHit(String url, long hitTime) {
        queueToThread(new C04341(this, hitTime, url));
    }
    ...
    public void run() {
        while (!this.mClosed) {
            try {
                ...
                Log.m1391i(e.toString());
            } catch (Throwable t) {
                Log.m1389e("Error on GAThread: " + printStackTrace(t));
                Log.m1389e("Google Analytics is shutting down.");
                this.mDisabled = true;
            }
        }
    }

...
public abstract class AbstractMutableMessageLite implements MutableMessageLite {
    ...
    /* renamed from: com.google.tagmanager.protobuf.AbstractMutableMessageLite.1 */
    static class C09861 extends AbstractParser<T> {
        final /* synthetic */ MutableMessageLite val$defaultInstance;

        C09861(MutableMessageLite mutableMessageLite) {
    ...
    public boolean mergeDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry) {
        ...
        try {
            ...
            if (firstByte != -1) {
                z = mergeFrom(new LimitedInputStream(input, CodedInputStream.readRawVarint32(firstByte, input)), extensionRegistry);
            }
        } catch (IOException e) {
        }
        return z;
    ...
    protected static <T extends MutableMessageLite> Parser<T> internalNewParserForType(T defaultInstance) {
        return new C09861(defaultInstance);
    }

...
public final class CodedOutputStream {
    ...
    public void writeRawVarint32(int value) throws IOException {
        while ((value & -128) != 0) {
            writeRawByte((value & TransportMediator.KEYCODE_MEDIA_PAUSE) | TransportMediator.FLAG_KEY_MEDIA_NEXT);
            value >>>= 7;
        }
        writeRawByte(value);
    }
    ...
    public void writeRawVarint64(long value) throws IOException {
        while ((-128 & value) != 0) {
            writeRawByte((((int) value) & TransportMediator.KEYCODE_MEDIA_PAUSE) | TransportMediator.FLAG_KEY_MEDIA_NEXT);
            value >>>= 7;
        }
    ...
    public void writeRawLittleEndian32(int value) throws IOException {
        ...
        writeRawByte((value >> LITTLE_ENDIAN_64_SIZE) & MotionEventCompat.ACTION_MASK);
    ...
    public void writeRawLittleEndian64(long value) throws IOException {
        ...
        writeRawByte(((int) (value >> LITTLE_ENDIAN_64_SIZE)) & MotionEventCompat.ACTION_MASK);

...
class SmallSortedMap<K extends Comparable<K>, V> extends AbstractMap<K, V> {
    ...
    private static class EmptySet {
        ...
        static class C04581 implements Iterator<Object> {
            C04581() {
            }
        ...
        static class C04592 implements Iterable<Object> {
            C04592() {
            }
    ...
    static class C08261 extends SmallSortedMap<FieldDescriptorType, Object> {
        C08261(int x0) {
            super(null);
        }

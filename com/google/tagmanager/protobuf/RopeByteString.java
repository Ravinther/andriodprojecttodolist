...
class RopeByteString extends ByteString {
    ...
    private class RopeInputStream extends InputStream {
        ...
        public int read() throws IOException {
            ...
            return literalByteString.byteAt(i) & MotionEventCompat.ACTION_MASK;
        }
        ...
        private void initialize() {
            this.pieceIterator = new PieceIterator(null);
    ...
    private class RopeByteIterator implements ByteIterator {
        ...
        private RopeByteIterator() {
            this.pieces = new PieceIterator(null);
    ...
    static ByteString concatenate(ByteString left, ByteString right) {
        ...
        if (newLength < TransportMediator.FLAG_KEY_MEDIA_NEXT) {
            return concatenateBytes(left, right);
        }
        if (leftRope != null && leftRope.right.size() + right.size() < TransportMediator.FLAG_KEY_MEDIA_NEXT) {

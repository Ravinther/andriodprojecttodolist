...
public class TagManager {
    ...
    /* renamed from: com.google.tagmanager.TagManager.1 */
    class C08241 implements Listener {
        C08241() {
        }

        public void changed(Map<Object, Object> update) {
            Object eventValue = update.get(DataLayer.EVENT_KEY);
            if (eventValue != null) {
    ...
    /* renamed from: com.google.tagmanager.TagManager.2 */
    static class C08252 implements ContainerProvider {
        C08252() {
        }
    ...
    TagManager(Context context, ContainerProvider containerProvider, DataLayer dataLayer) {
        ...
        this.mDataLayer.registerListener(new C08241());
    ...
    public static TagManager getInstance(Context context) {
        ...
        synchronized (TagManager.class) {
            if (sInstance == null) {
                sInstance = new TagManager(context, new C08252(), new DataLayer());
            }
    ...
    L_0x000b:
        ...
        r6 = com.google.tagmanager.TagManager.C04443.$SwitchMap$com$google$tagmanager$PreviewManager$PreviewMode;	 Catch:{ all -> 0x0033 }

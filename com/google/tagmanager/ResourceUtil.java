...
class ResourceUtil {
    ...
    static /* synthetic */ class C04391 {
        ...
        static {
            ...
            try {
                f50xa390a19[Type.STRING.ordinal()] = 5;
            } catch (NoSuchFieldError e5) {
            }
            try {
                f50xa390a19[Type.FUNCTION_ID.ordinal()] = 6;
            } catch (NoSuchFieldError e6) {
            }
            try {
                f50xa390a19[Type.INTEGER.ordinal()] = 7;
            } catch (NoSuchFieldError e7) {
            }
            try {
                f50xa390a19[Type.BOOLEAN.ordinal()] = 8;
    ...
    private static Value expandValue(int i, Resource resource, Value[] expandedValues, Set<Integer> pendingExpansions) throws InvalidResourceException {
        ...
        switch (C04391.f50xa390a19[value.getType().ordinal()]) {

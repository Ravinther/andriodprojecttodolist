...
public final class TypeSystem {
    ...
    public static final class Value extends ExtendableMessage<Value> implements ValueOrBuilder {
        ...
        public enum Escaping implements EnumLite {
            ...
            static class C04961 implements EnumLiteMap<Escaping> {
                C04961() {
                }
        ...
        public enum Type implements EnumLite {
            ...
            static class C04971 implements EnumLiteMap<Type> {
                C04971() {
                }
        ...
        static class C08501 extends AbstractParser<Value> {
            C08501() {
            }
                ...
                try {
                    ...
                    switch (tag) {
                        ...
                        case 80:
                            ...
                            if (value != null) {
                                if ((mutable_bitField0_ & AccessibilityNodeInfoCompat.ACTION_NEXT_HTML_ELEMENT) != AccessibilityNodeInfoCompat.ACTION_NEXT_HTML_ELEMENT) {
                                    this.escaping_ = new ArrayList();
                                    mutable_bitField0_ |= AccessibilityNodeInfoCompat.ACTION_NEXT_HTML_ELEMENT;
                                }
                                this.escaping_.add(value);
                                break;
                            }
                    ...
                    if ((mutable_bitField0_ & AccessibilityNodeInfoCompat.ACTION_NEXT_HTML_ELEMENT) == 1024) {
                        this.escaping_ = Collections.unmodifiableList(this.escaping_);
                    }
                    if ((mutable_bitField0_ & AccessibilityNodeInfoCompat.ACTION_PREVIOUS_AT_MOVEMENT_GRANULARITY) == 512) {
                        this.templateToken_ = Collections.unmodifiableList(this.templateToken_);
                    }
                    try {

...
public class GAServiceManager extends ServiceManager {
    ...
    class C04991 implements AnalyticsStoreStateListener {
        C04991() {
        }
    ...
    private void initializeHandler() {
        this.handler = new Handler(this.ctx.getMainLooper(), new C00762());
    ...
    public synchronized void dispatchLocalHits() {
        if (this.thread == null) {
            Log.m13v("Dispatch call queued. Dispatch will run once initialization is complete.");
            this.pendingDispatch = true;
        } else {
    ...
    public synchronized void setLocalDispatchPeriod(int dispatchPeriodInSeconds) {
        if (this.handler == null) {
            Log.m13v("Dispatch period set with null handler. Dispatch will run once initialization is complete.");
    ...
    public void setForceLocalDispatch() {
        if (this.thread == null) {
            Log.m13v("setForceLocalDispatch() queued. It will be called once initialization is complete.");
    ...
    synchronized void updatePowerSaveMode(boolean storeIsEmpty, boolean connected) {
        if (!(this.storeIsEmpty == storeIsEmpty && this.connected == connected)) {
            ...
            Log.m13v(append.append(str).toString());

...
public class EasyTracker extends Tracker {
    ...
    private void loadParameters() {
        ...
        if (logLevelString != null) {
            ...
            if (logLevel != null) {
                Log.m13v("[EasyTracker] log level loaded: " + logLevel);
        ...
        Log.m13v("[EasyTracker] sample rate loaded: " + sampleRate);
        int dispatchPeriod = this.mParameterFetcher.getInt("ga_dispatchPeriod", 1800);
        Log.m13v("[EasyTracker] dispatch period loaded: " + dispatchPeriod);
        ...
        Log.m13v("[EasyTracker] session timeout loaded: " + this.mSessionTimeout);
        ...
        Log.m13v("[EasyTracker] auto activity tracking loaded: " + this.mIsAutoActivityTracking);
        ...
        if (isAnonymizeIpEnabled) {
            ...
            Log.m13v("[EasyTracker] anonymize ip loaded: " + isAnonymizeIpEnabled);
        }
        ...
        if (this.mIsReportUncaughtExceptionsEnabled) {
            ...
            Log.m13v("[EasyTracker] report uncaught exceptions loaded: " + this.mIsReportUncaughtExceptionsEnabled);
        }
    ...
    private void setContext(Context ctx, ParameterLoader parameterLoader, ServiceManager serviceManager) {
        if (ctx == null) {
            Log.m11e("Context cannot be null");
        }

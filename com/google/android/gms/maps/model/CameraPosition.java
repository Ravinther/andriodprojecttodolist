...
public final class CameraPosition implements SafeParcelable {
    ...
    CameraPosition(int versionCode, LatLng target, float zoom, float tilt, float bearing) {
        er.m719b((Object) target, (Object) "null camera target");
        boolean z = 0.0f <= tilt && tilt <= 90.0f;
        er.m720b(z, (Object) "Tilt needs to be between 0 and 90 inclusive");
        this.wj = versionCode;
        this.target = target;
        this.zoom = zoom;
        this.tilt = tilt + 0.0f;
    ...
    public String toString() {
        return ep.m713e(this).m712a("target", this.target).m712a("zoom", Float.valueOf(this.zoom)).m712a("tilt", Float.valueOf(this.tilt)).m712a("bearing", Float.valueOf(this.bearing)).toString();
    }

    public void writeToParcel(Parcel out, int flags) {
        if (C0329r.hc()) {
            C0330a.m1153a(this, out, flags);
        } else {
            CameraPositionCreator.m1141a(this, out, flags);
        }
    }
}

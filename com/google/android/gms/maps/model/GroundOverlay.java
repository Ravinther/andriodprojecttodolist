...
public final class GroundOverlay {
    private final C0341c PR;

    public GroundOverlay(C0341c delegate) {
        this.PR = (C0341c) er.m721f(delegate);
    }
    ...
    public boolean equals(Object other) {
        ...
        try {
            return this.PR.m1166a(((GroundOverlay) other).PR);
    ...
    public void setPositionFromBounds(LatLngBounds bounds) {
        try {
            this.PR.setPositionFromBounds(bounds);
        } catch (RemoteException e) {
            throw new RuntimeRemoteException(e);
        }
    }
    ...
    public void setTransparency(float transparency) {
        try {
            this.PR.setTransparency(transparency);
        } catch (RemoteException e) {
            throw new RuntimeRemoteException(e);
        }
    }

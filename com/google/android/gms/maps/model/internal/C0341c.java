...
public interface C0341c extends IInterface {

    /* renamed from: com.google.android.gms.maps.model.internal.c.a */
    public static abstract class C0734a extends Binder implements C0341c {

        /* renamed from: com.google.android.gms.maps.model.internal.c.a.a */
        private static class C0733a implements C0341c {
            private IBinder ky;
            ...
            public void m2186a(float f, float f2) throws RemoteException {
            ...
            public boolean m2187a(C0341c c0341c) throws RemoteException {
                boolean z = false;
                Parcel obtain = Parcel.obtain();
                Parcel obtain2 = Parcel.obtain();
                try {
                    obtain.writeInterfaceToken("com.google.android.gms.maps.model.internal.IGroundOverlayDelegate");
                    obtain.writeStrongBinder(c0341c != null ? c0341c.asBinder() : null);
            ...
            public void m2188h(C0192b c0192b) throws RemoteException {
                Parcel obtain = Parcel.obtain();
                Parcel obtain2 = Parcel.obtain();
                try {
                    obtain.writeInterfaceToken("com.google.android.gms.maps.model.internal.IGroundOverlayDelegate");
        ...
        public static C0341c ap(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            IInterface queryLocalInterface = iBinder.queryLocalInterface("com.google.android.gms.maps.model.internal.IGroundOverlayDelegate");
            return (queryLocalInterface == null || !(queryLocalInterface instanceof C0341c)) ? new C0733a(iBinder) : (C0341c) queryLocalInterface;
        }
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                ...
                case Value.MACRO_REFERENCE_FIELD_NUMBER /*6*/:
                    data.enforceInterface("com.google.android.gms.maps.model.internal.IGroundOverlayDelegate");
                    m1165a(data.readFloat(), data.readFloat());
                    reply.writeNoException();
                    return true;
                ...
                case TimeUtils.HUNDRED_DAY_FIELD_LEN /*19*/:
                    data.enforceInterface("com.google.android.gms.maps.model.internal.IGroundOverlayDelegate");
                    isVisible = m1166a(C0734a.ap(data.readStrongBinder()));
                    reply.writeNoException();
                    if (isVisible) {
                        i = 1;
                    }
                ...
                case 21:
                    data.enforceInterface("com.google.android.gms.maps.model.internal.IGroundOverlayDelegate");
                    m1167h(C0557a.m1641G(data.readStrongBinder()));
                    reply.writeNoException();
                    return true;
                case 1598968902:
    ...
    void m1165a(float f, float f2) throws RemoteException;

    boolean m1166a(C0341c c0341c) throws RemoteException;
    ...
    void m1167h(C0192b c0192b) throws RemoteException;

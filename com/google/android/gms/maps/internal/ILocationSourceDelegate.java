...
import com.google.android.gms.maps.internal.C0318g.C0709a;

public interface ILocationSourceDelegate extends IInterface {

    /* renamed from: com.google.android.gms.maps.internal.ILocationSourceDelegate.a */
    public static abstract class C0689a extends Binder implements ILocationSourceDelegate {

        /* renamed from: com.google.android.gms.maps.internal.ILocationSourceDelegate.a.a */
        private static class C0688a implements ILocationSourceDelegate {
            private IBinder ky;
            ...
            public void activate(C0318g listener) throws RemoteException {
        ...
        public static ILocationSourceDelegate m2153X(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            IInterface queryLocalInterface = iBinder.queryLocalInterface("com.google.android.gms.maps.internal.ILocationSourceDelegate");
            return (queryLocalInterface == null || !(queryLocalInterface instanceof ILocationSourceDelegate)) ? new C0688a(iBinder) : (ILocationSourceDelegate) queryLocalInterface;
        }
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            switch (code) {
                case Value.TYPE_FIELD_NUMBER /*1*/:
                    ...
                    activate(C0709a.ac(data.readStrongBinder()));
    ...
    void activate(C0318g c0318g) throws RemoteException;

...
public interface C0321j extends IInterface {

    /* renamed from: com.google.android.gms.maps.internal.j.a */
    public static abstract class C0715a extends Binder implements C0321j {

        /* renamed from: com.google.android.gms.maps.internal.j.a.a */
        private static class C0714a implements C0321j {
            private IBinder ky;
        ...
        public static C0321j af(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            IInterface queryLocalInterface = iBinder.queryLocalInterface("com.google.android.gms.maps.internal.IOnMapLongClickListener");
            return (queryLocalInterface == null || !(queryLocalInterface instanceof C0321j)) ? new C0714a(iBinder) : (C0321j) queryLocalInterface;
        }

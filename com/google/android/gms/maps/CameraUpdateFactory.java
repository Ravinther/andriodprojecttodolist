...
public final class CameraUpdateFactory {
    ...
    static void m1115a(ICameraUpdateFactoryDelegate iCameraUpdateFactoryDelegate) {
        if (OJ == null) {
            OJ = (ICameraUpdateFactoryDelegate) er.m721f(iCameraUpdateFactoryDelegate);
        }
    }

    private static ICameraUpdateFactoryDelegate gL() {
        return (ICameraUpdateFactoryDelegate) er.m719b(OJ, (Object) "CameraUpdateFactory is not initialized");
    }

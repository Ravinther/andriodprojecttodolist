...
class ak {
    ...
    public static Map<String, String> m53I(String str) {
    ...
    public static String m54J(String str) {
    ...
    public static double m55a(String str, double d) {
        if (str != null) {
            try {
    ...
    static String m56a(Locale locale) {
    ...
    public static void m57a(Map<String, String> map, String str, String str2) {
        if (!map.containsKey(str)) {
            map.put(str, str2);
        }
    }

    public static boolean m58d(String str, boolean z) {

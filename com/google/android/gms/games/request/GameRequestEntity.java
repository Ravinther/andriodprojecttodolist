...
public final class GameRequestEntity implements SafeParcelable, GameRequest {
    ...
    static int m2469a(GameRequest gameRequest) {
        return ep.hashCode(gameRequest.getGame(), gameRequest.fU(), gameRequest.getRequestId(), gameRequest.getSender(), m2471b(gameRequest), Integer.valueOf(gameRequest.getType()), Long.valueOf(gameRequest.getCreationTimestamp()), Long.valueOf(gameRequest.getExpirationTimestamp()));
    }

    static boolean m2470a(GameRequest gameRequest, Object obj) {
        ...
        return ep.equal(gameRequest2.getGame(), gameRequest.getGame()) && ep.equal(gameRequest2.fU(), gameRequest.fU()) && ep.equal(gameRequest2.getRequestId(), gameRequest.getRequestId()) && ep.equal(gameRequest2.getSender(), gameRequest.getSender()) && Arrays.equals(m2471b(gameRequest2), m2471b(gameRequest)) && ep.equal(Integer.valueOf(gameRequest2.getType()), Integer.valueOf(gameRequest.getType())) && ep.equal(Long.valueOf(gameRequest2.getCreationTimestamp()), Long.valueOf(gameRequest.getCreationTimestamp())) && ep.equal(Long.valueOf(gameRequest2.getExpirationTimestamp()), Long.valueOf(gameRequest.getExpirationTimestamp()));
    }

    private static int[] m2471b(GameRequest gameRequest) {
    ...
    static String m2472c(GameRequest gameRequest) {
        return ep.m713e(gameRequest).m712a("Game", gameRequest.getGame()).m712a("Sender", gameRequest.getSender()).m712a("Recipients", gameRequest.fU()).m712a("Data", gameRequest.getData()).m712a("RequestId", gameRequest.getRequestId()).m712a("Type", Integer.valueOf(gameRequest.getType())).m712a("CreationTimestamp", Long.valueOf(gameRequest.getCreationTimestamp())).m712a("ExpirationTimestamp", Long.valueOf(gameRequest.getExpirationTimestamp())).toString();
    }
    ...
    public void writeToParcel(Parcel dest, int flags) {
        GameRequestEntityCreator.m370a(this, dest, flags);
    }
}

...
public final class GameEntity extends fy implements Game {
    ...
    static final class C0558a extends C0196a {
        C0558a() {
        }

        public GameEntity aj(Parcel parcel) {
            if (fy.m2750c(eg.dY()) || eg.ae(GameEntity.class.getCanonicalName())) {
    ...
    static boolean m2980a(Game game, Object obj) {
    ...
    static String m2981b(Game game) {
        return ep.m713e(game).m712a("ApplicationId", game.getApplicationId()).m712a("DisplayName", game.getDisplayName()).m712a("PrimaryCategory", game.getPrimaryCategory()).m712a("SecondaryCategory", game.getSecondaryCategory()).m712a("Description", game.getDescription()).m712a("DeveloperName", game.getDeveloperName()).m712a("IconImageUri", game.getIconImageUri()).m712a("IconImageUrl", game.getIconImageUrl()).m712a("HiResImageUri", game.getHiResImageUri()).m712a("HiResImageUrl", game.getHiResImageUrl()).m712a("FeaturedImageUri", game.getFeaturedImageUri()).m712a("FeaturedImageUrl", game.getFeaturedImageUrl()).m712a("PlayEnabledGame", Boolean.valueOf(game.isPlayEnabledGame())).m712a("InstanceInstalled", Boolean.valueOf(game.isInstanceInstalled())).m712a("InstancePackageName", game.getInstancePackageName()).m712a("AchievementTotalCount", Integer.valueOf(game.getAchievementTotalCount())).m712a("LeaderboardCount", Integer.valueOf(game.getLeaderboardCount())).m712a("RealTimeMultiplayerEnabled", Boolean.valueOf(game.isRealTimeMultiplayerEnabled())).m712a("TurnBasedMultiplayerEnabled", Boolean.valueOf(game.isTurnBasedMultiplayerEnabled())).toString();
    }

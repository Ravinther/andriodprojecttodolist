...
public final class RoomEntity extends fy implements Room {
    ...
    static final class C0564a extends C0204b {
        C0564a() {
        }

        public RoomEntity aq(Parcel parcel) {
            if (fy.m2750c(eg.dY()) || eg.ae(RoomEntity.class.getCanonicalName())) {
    ...
    static int m2998a(Room room, String str) {
        ArrayList participants = room.getParticipants();
        int size = participants.size();
        for (int i = 0; i < size; i++) {
    ...
    static boolean m2999a(Room room, Object obj) {
    ...
    static String m3000b(Room room) {
        return ep.m713e(room).m712a("RoomId", room.getRoomId()).m712a("CreatorId", room.getCreatorId()).m712a("CreationTimestamp", Long.valueOf(room.getCreationTimestamp())).m712a("RoomStatus", Integer.valueOf(room.getStatus())).m712a("Description", room.getDescription()).m712a("Variant", Integer.valueOf(room.getVariant())).m712a("AutoMatchCriteria", room.getAutoMatchCriteria()).m712a("Participants", room.getParticipants()).m712a("AutoMatchWaitEstimateSeconds", Integer.valueOf(room.getAutoMatchWaitEstimateSeconds())).toString();
    }

    static String m3001b(Room room, String str) {
        ArrayList participants = room.getParticipants();
        int size = participants.size();
        for (int i = 0; i < size; i++) {
            Participant participant = (Participant) participants.get(i);
    ...
    static Participant m3003c(Room room, String str) {
        ArrayList participants = room.getParticipants();
        int size = participants.size();
        for (int i = 0; i < size; i++) {
            Participant participant = (Participant) participants.get(i);
    ...
    static ArrayList<String> m3004c(Room room) {
        ArrayList participants = room.getParticipants();
        int size = participants.size();
    ...
    public Participant getParticipant(String participantId) {
        return m3003c(this, participantId);
    }

    public String getParticipantId(String playerId) {
        return m3001b(this, playerId);
    }
    ...
    public int getParticipantStatus(String participantId) {
        return m2998a((Room) this, participantId);
    }

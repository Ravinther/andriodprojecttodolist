...
public final class TurnBasedMatchEntity implements SafeParcelable, TurnBasedMatch {
    ...
    static int m2461a(TurnBasedMatch turnBasedMatch) {
    ...
    static int m2462a(TurnBasedMatch turnBasedMatch, String str) {
    ...
    static boolean m2463a(TurnBasedMatch turnBasedMatch, Object obj) {
    ...
    static String m2464b(TurnBasedMatch turnBasedMatch) {
        return ep.m713e(turnBasedMatch).m712a("Game", turnBasedMatch.getGame()).m712a("MatchId", turnBasedMatch.getMatchId()).m712a("CreatorId", turnBasedMatch.getCreatorId()).m712a("CreationTimestamp", Long.valueOf(turnBasedMatch.getCreationTimestamp())).m712a("LastUpdaterId", turnBasedMatch.getLastUpdaterId()).m712a("LastUpdatedTimestamp", Long.valueOf(turnBasedMatch.getLastUpdatedTimestamp())).m712a("PendingParticipantId", turnBasedMatch.getPendingParticipantId()).m712a("MatchStatus", Integer.valueOf(turnBasedMatch.getStatus())).m712a("TurnStatus", Integer.valueOf(turnBasedMatch.getTurnStatus())).m712a("Description", turnBasedMatch.getDescription()).m712a("Variant", Integer.valueOf(turnBasedMatch.getVariant())).m712a("Data", turnBasedMatch.getData()).m712a("Version", Integer.valueOf(turnBasedMatch.getVersion())).m712a("Participants", turnBasedMatch.getParticipants()).m712a("RematchId", turnBasedMatch.getRematchId()).m712a("PreviousData", turnBasedMatch.getPreviousMatchData()).m712a("MatchNumber", Integer.valueOf(turnBasedMatch.getMatchNumber())).m712a("AutoMatchCriteria", turnBasedMatch.getAutoMatchCriteria()).m712a("AvailableAutoMatchSlots", Integer.valueOf(turnBasedMatch.getAvailableAutoMatchSlots())).m712a("LocallyModified", Boolean.valueOf(turnBasedMatch.isLocallyModified())).m712a("DescriptionParticipantId", turnBasedMatch.getDescriptionParticipantId()).toString();
    }

    static String m2465b(TurnBasedMatch turnBasedMatch, String str) {
        ArrayList participants = turnBasedMatch.getParticipants();
        int size = participants.size();
        for (int i = 0; i < size; i++) {
            Participant participant = (Participant) participants.get(i);
    ...
    static Participant m2466c(TurnBasedMatch turnBasedMatch, String str) {
        ArrayList participants = turnBasedMatch.getParticipants();
        int size = participants.size();
        for (int i = 0; i < size; i++) {
            Participant participant = (Participant) participants.get(i);
    ...
    static ArrayList<String> m2467c(TurnBasedMatch turnBasedMatch) {
        ArrayList participants = turnBasedMatch.getParticipants();
        int size = participants.size();
    ...
    public boolean equals(Object obj) {
        return m2463a((TurnBasedMatch) this, obj);
    }
    ...
    public Participant getParticipant(String participantId) {
        return m2466c(this, participantId);
    }

    public String getParticipantId(String playerId) {
        return m2465b(this, playerId);
    }
    ...
    public int getParticipantStatus(String participantId) {
        return m2462a((TurnBasedMatch) this, participantId);
    }
    ...
    public void writeToParcel(Parcel out, int flags) {
        TurnBasedMatchEntityCreator.m369a(this, out, flags);
    }
}

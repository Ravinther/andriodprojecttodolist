...
public final class ScoreSubmissionData {
    ...
    public static final class Result {
        ...
        public String toString() {
            return ep.m713e(this).m712a("RawScore", Long.valueOf(this.rawScore)).m712a("FormattedScore", this.formattedScore).m712a("ScoreTag", this.scoreTag).m712a("NewBest", Boolean.valueOf(this.newBest)).toString();
        }
    }
    ...
    public ScoreSubmissionData(DataHolder dataHolder) {
        ...
        for (int i = 0; i < count; i++) {
            ...
            if (dataHolder.getBoolean("hasResult", i, I)) {
                m363a(new Result(dataHolder.getLong("rawScore", i, I), dataHolder.getString("formattedScore", i, I), dataHolder.getString("scoreTag", i, I), dataHolder.getBoolean("newBest", i, I)), dataHolder.getInteger("timeSpan", i, I));
            }
        }
    }

    private void m363a(Result result, int i) {
    ...
    public String toString() {
        C0277a a = ep.m713e(this).m712a("PlayerId", this.Gh).m712a("StatusCode", Integer.valueOf(this.yJ));
        for (int i = 0; i < 3; i++) {
            Result result = (Result) this.Jp.get(Integer.valueOf(i));
            a.m712a("TimesSpan", gu.aW(i));
            a.m712a("Result", result == null ? "null" : result.toString());
        }
        return a.toString();
    }
}

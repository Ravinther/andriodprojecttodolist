...
public final class gz implements SafeParcelable, GameRequest {
    ...
    private void fR() {
        ...
        for (int i = 1; i < size; i++) {
            ...
            ed.m660a(gameRequest.getType() == gameRequest2.getType(), "All the requests must be of the same type");
            ed.m660a(gameRequest.getSender().equals(gameRequest2.getSender()), "All the requests must be from the same sender");
        }
    }

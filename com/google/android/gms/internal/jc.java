...
import com.google.android.gms.internal.ir.C0292e;
...
public final class jc extends C0142b implements Person {
    ...
    public Image getImage() {
        return new C0951c(getString("image"));
    }
    ...
    public int getObjectType() {
        return C0292e.aT(getString("objectType"));
    }
    ...
    public Person it() {
        return new ir(getDisplayName(), getId(), (C0951c) getImage(), getObjectType(), getUrl());
    }
}

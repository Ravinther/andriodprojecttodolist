...
public final class cn {
    ...
    public cn(C0673z c0673z, dd ddVar, List<String> list, int i, List<String> list2, List<String> list3, int i2, long j, String str, boolean z, ax axVar, bg bgVar, String str2, ay ayVar, ba baVar, long j2, ab abVar, long j3, long j4, long j5) {
        this.oc = c0673z;
        this.nu = ddVar;

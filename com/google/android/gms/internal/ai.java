...
public interface ai extends IInterface {
    ...
    public static abstract class C0573a extends Binder implements ai {

        /* renamed from: com.google.android.gms.internal.ai.a.a */
        private static class C0572a implements ai {
            private IBinder ky;
        ...
        public static ai m1660h(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            IInterface queryLocalInterface = iBinder.queryLocalInterface("com.google.android.gms.ads.internal.client.IAppEventListener");
            return (queryLocalInterface == null || !(queryLocalInterface instanceof ai)) ? new C0572a(iBinder) : (ai) queryLocalInterface;
        }

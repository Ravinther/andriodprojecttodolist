...
public final class jy {
    ...
    public static jy m1017a(byte[] bArr, int i, int i2) {
    ...
    public static jy m1018n(byte[] bArr) {
        return m1017a(bArr, 0, bArr.length);
    }

    public static long m1019w(long j) {
        return (j >>> 1) ^ (-(1 & j));
    }

    public void m1020a(ke keVar) throws IOException {
        int kE = kE();
    ...
    public void m1021a(ke keVar, int i) throws IOException {
        if (this.aaa >= this.aab) {
            throw kd.kU();
        }
        this.aaa++;
    ...
    public byte[] m1022e(int i, int i2) {
        if (i2 == 0) {
            return kh.aaq;
        }

...
public final class bd {
    public static List<String> m432a(JSONObject jSONObject, String str) throws JSONException {
    ...
    public static void m433a(Context context, String str, cn cnVar, String str2, boolean z, List<String> list) {
        String str3 = z ? "1" : "0";

...
public final class kh {
    ...
    public static boolean m1070b(jy jyVar, int i) throws IOException {
        return jyVar.cv(i);
    }

    public static final int m1071c(jy jyVar, int i) throws IOException {
        int i2 = 1;
    ...
    static int m1072i(int i, int i2) {
        return (i << 3) | i2;
    }
}

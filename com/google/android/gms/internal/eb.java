...
public final class eb {
    public static Bitmap m655a(Bitmap bitmap) {
        if (bitmap == null) {
            return null;
        }
    ...
    private static Bitmap m656a(Drawable drawable) {
        if (drawable == null) {
            return null;
        }
    ...
    public static Drawable m657a(Resources resources, Drawable drawable) {
        return new BitmapDrawable(resources, m655a(m656a(drawable)));
    }
}

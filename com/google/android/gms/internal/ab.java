...
public final class ab implements SafeParcelable {
    ...
    public ab(Context context, AdSize[] adSizeArr) {
        ...
        if (i4 != 0) {
            this.widthPixels = m1646a(displayMetrics);
            i = (int) (((float) this.widthPixels) / displayMetrics.density);
        } else {
            i2 = this.width;
            this.widthPixels = cz.m553a(displayMetrics, this.width);
            i = i2;
        }
        i2 = i5 != 0 ? m1648c(displayMetrics) : this.height;
        this.heightPixels = cz.m553a(displayMetrics, i2);
        if (i4 == 0 && i5 == 0) {
    ...
    public static int m1646a(DisplayMetrics displayMetrics) {
        return displayMetrics.widthPixels;
    }

    public static int m1647b(DisplayMetrics displayMetrics) {
        return (int) (((float) m1648c(displayMetrics)) * displayMetrics.density);
    }

    private static int m1648c(DisplayMetrics displayMetrics) {
        int i = (int) (((float) displayMetrics.heightPixels) / displayMetrics.density);
        return i <= 400 ? 32 : i <= 720 ? 50 : 90;
    }

    public AdSize ai() {
        return C0085a.m17a(this.width, this.height, this.ln);
    }

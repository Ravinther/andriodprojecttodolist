...
public final class ay {
    ...
    public ay(String str) throws JSONException {
        ...
        if (da.m561n(2)) {
            da.m565v("Mediation Response JSON: " + jSONObject.toString(2));
        }
        ...
        if (optJSONObject != null) {
            ...
            this.mt = bd.m432a(optJSONObject, "click_urls");
            this.mu = bd.m432a(optJSONObject, "imp_urls");
            this.mv = bd.m432a(optJSONObject, "nofill_urls");
    ...
    private boolean m425a(ax axVar) {

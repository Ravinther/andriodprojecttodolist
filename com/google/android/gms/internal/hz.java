...
public final class hz implements SafeParcelable {
    ...
    public String toString() {
        return ep.m713e(this).m712a("name", this.name).m712a("address", this.Ov).m712a("internationalPhoneNumber", this.Ow).m712a("regularOpenHours", this.Ox).m712a("attributions", this.Oy).toString();
    }

    public void writeToParcel(Parcel parcel, int flags) {
        ia iaVar = CREATOR;
        ia.m981a(this, parcel, flags);
    }
}

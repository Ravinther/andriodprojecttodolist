...
public final class cm {
    ...
    public cm(Context context) {
        ...
        this.oN = m506a(packageManager, "geo:0,0?q=donuts") != null;
        if (m506a(packageManager, "http://www.google.com") == null) {
            z = false;
        }
        this.oO = z;
        ...
        this.oV = m507a(packageManager);
        this.oW = audioManager.getStreamVolume(3);
        this.oX = m505a(context, connectivityManager, packageManager);
    ...
    private static int m505a(Context context, ConnectivityManager connectivityManager, PackageManager packageManager) {
        if (!cv.m533a(packageManager, context.getPackageName(), "android.permission.ACCESS_NETWORK_STATE")) {
            return -2;
        }
    ...
    private static ResolveInfo m506a(PackageManager packageManager, String str) {
        return packageManager.resolveActivity(new Intent("android.intent.action.VIEW", Uri.parse(str)), Cast.MAX_MESSAGE_LENGTH);
    }

    private static String m507a(PackageManager packageManager) {
        String str = null;
        ResolveInfo a = m506a(packageManager, "market://details?id=com.google.android.gms.ads");
        if (a != null) {

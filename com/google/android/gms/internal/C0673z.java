...
public final class C0673z implements SafeParcelable {
    ...
    C0673z(int i, long j, Bundle bundle, int i2, List<String> list, boolean z, int i3, boolean z2, String str, am amVar, Location location, String str2) {
        this.versionCode = i;
        this.le = j;
        this.extras = bundle;
        this.lf = i2;
    ...
    public C0673z(Context context, aj ajVar) {
        am amVar = null;
        this.versionCode = 3;

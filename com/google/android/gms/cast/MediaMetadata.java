...
public class MediaMetadata {
    ...
    private static final C0127a wS;
                ...
                if (this.wT.containsKey(str)) {
                    switch (wS.m101O(str)) {
                        ...
                        case MEDIA_TYPE_PHOTO /*4*/:
                            jSONObject.put(wS.m99M(str), this.wT.getString(str));
                            break;
                        case MEDIA_TYPE_TV_SHOW /*2*/:
                            jSONObject.put(wS.m99M(str), this.wT.getInt(str));
                            break;
                        case MEDIA_TYPE_MUSIC_TRACK /*3*/:
                            jSONObject.put(wS.m99M(str), this.wT.getDouble(str));
                            break;
                        default:
                            break;
                    }
    ...
    public boolean equals(Object other) {
        ...
        return m104a(this.wT, mediaMetadata.wT) && this.wl.equals(mediaMetadata.wl);
    }

    public Calendar getDate(String key) {
        m106d(key, MEDIA_TYPE_PHOTO);
        String string = this.wT.getString(key);
        return string != null ? dz.m648V(string) : null;
    }
    ...
    public void putDate(String key, Calendar value) {
        m106d(key, MEDIA_TYPE_PHOTO);
        this.wT.putString(key, dz.m652a(value));
    }

...
public final class MediaInfo {
    ...
    MediaInfo(JSONObject json) throws JSONException {
        ...
        if (json.has("metadata")) {
            ...
            this.wN.m107b(jSONObject);
        }
        this.wO = dr.m612b(json.optDouble("duration", 0.0d));
        this.wP = json.optJSONObject("customData");
    }

    void m96a(MediaMetadata mediaMetadata) {
        this.wN = mediaMetadata;
    }

    void m97a(JSONObject jSONObject) {
        this.wP = jSONObject;
    }
    ...
    public JSONObject cT() {
        ...
        try {
            ...
            jSONObject.put("duration", dr.m613l(this.wO));
            if (this.wP != null) {
    ...
    public boolean equals(Object other) {
        ...
        if (this.wP != null && mediaInfo.wP != null && !fp.m772d(this.wP, mediaInfo.wP)) {
            return false;
        }
        if (!(dr.m611a(this.wK, mediaInfo.wK) && this.wL == mediaInfo.wL && dr.m611a(this.wM, mediaInfo.wM) && dr.m611a(this.wN, mediaInfo.wN) && this.wO == mediaInfo.wO)) {
            z = false;
        }
        return z;
    }
    ...
    void m98j(long j) throws IllegalArgumentException {
        if (j < 0) {

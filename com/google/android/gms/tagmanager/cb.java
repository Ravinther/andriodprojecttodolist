...
import com.google.android.gms.tagmanager.db.C0396a;
...
class cb implements at {
    ...
    class C0376b extends SQLiteOpenHelper {
        final /* synthetic */ cb VO;
        private boolean ui;
        private long uj;

        C0376b(cb cbVar, Context context, String str) {
            this.VO = cbVar;
            super(context, str, null, 1);
            this.uj = 0;
        }

        private void m1282a(SQLiteDatabase sQLiteDatabase) {
        ...
        private boolean m1283a(String str, SQLiteDatabase sQLiteDatabase) {
            Cursor cursor;
            Throwable th;
            Cursor cursor2 = null;
            try {
    ...
    class C0776a implements C0396a {
        final /* synthetic */ cb VO;
        ...
        public void m2287a(ap apVar) {
            this.VO.m2298u(apVar.ci());
        }

        public void m2288b(ap apVar) {
            this.VO.m2298u(apVar.ci());
            bh.m1268v("Permanent failure dispatching hitId: " + apVar.ci());
        }

        public void m2289c(ap apVar) {
            long je = apVar.je();
            if (je == 0) {
                this.VO.m2296c(apVar.ci(), this.VO.Ty.currentTimeMillis());
            } else if (je + 14400000 < this.VO.Ty.currentTimeMillis()) {
                this.VO.m2298u(apVar.ci());
                bh.m1268v("Giving up on failed hitId: " + apVar.ci());
            }
        }
    }
    ...
    cb(au auVar, Context context, String str, int i) {
        ...
        this.VN = auVar;
        this.Ty = fn.eI();
        this.VL = new C0376b(this, this.mContext, this.ud);
        this.VM = new db(new DefaultHttpClient(), this.mContext, new C0776a(this));
        this.uf = 0;
        this.ug = i;
    }

    private SQLiteDatabase m2290G(String str) {
        try {
    ...
    private void m2296c(long j, long j2) {
        SQLiteDatabase G = m2290G("Error opening database for getNumStoredHits.");
        if (G != null) {
            ...
            try {
                ...
                bh.m1269w("Error setting HIT_FIRST_DISPATCH_TIME for hitId: " + j);
                m2298u(j);
            }
        }
    }
    ...
    private void co() {
        ...
        if (cq > 0) {
            List s = m2301s(cq);
            bh.m1268v("Store full, deleting " + s.size() + " hits to make room.");
            m2299a((String[]) s.toArray(new String[0]));
        }
    }

    private void m2297f(long j, String str) {
        SQLiteDatabase G = m2290G("Error opening database for putHit");
        if (G != null) {
            ContentValues contentValues = new ContentValues();
            ...
            try {
                ...
                this.VN.m1253p(false);
            } catch (SQLiteException e) {
                bh.m1269w("Error storing hit");
            }
        }
    }

    private void m2298u(long j) {
        m2299a(new String[]{String.valueOf(j)});
    }

    void m2299a(String[] strArr) {
        boolean z = true;
        if (strArr != null && strArr.length != 0) {
            SQLiteDatabase G = m2290G("Error opening database for deleteHits.");
            if (G != null) {
                try {
    ...
    public void bp() {
        bh.m1268v("GTM Dispatch running...");
        if (this.VM.bA()) {
            List t = m2302t(40);
            if (t.isEmpty()) {
                bh.m1268v("...nothing to dispatch");
                this.VN.m1253p(true);
                return;
            }
            this.VM.m1241e(t);
    ...
    int cp() {
        ...
        SQLiteDatabase G = m2290G("Error opening database for deleteStaleHits.");
        if (G == null) {
            return 0;
        }
    ...
    int cq() {
        ...
        if (G != null) {
            try {
                ...
                bh.m1269w("Error getting numStoredHits");
                if (cursor != null) {
                    cursor.close();
                }
            } catch (Throwable th) {
    ...
    public void m2300e(long j, String str) {
        cp();
        co();
        m2297f(j, str);
    }
    ...
    int js() {
        ...
        try {
            ...
            try {
                ...
                cursor = query;
                try {
                    bh.m1269w("Error getting num untried hits");
                    if (cursor == null) {
                        count = 0;
                    } else {
                        cursor.close();
    ...
    List<String> m2301s(int i) {
        Cursor query;
        SQLiteException e;
        Throwable th;
        List<String> arrayList = new ArrayList();
        if (i <= 0) {
            bh.m1269w("Invalid maxHits specified. Skipping");
            return arrayList;
        }
        SQLiteDatabase G = m2290G("Error opening database for peekHitIds.");
        if (G == null) {
            return arrayList;
        }
        try {
            ...
            try {
                ...
                e = e2;
                try {
                    bh.m1269w("Error in peekHits fetching hitIds: " + e.getMessage());
                    if (query != null) {
                        query.close();
                    }
                    return arrayList;
    ...
    public java.util.List<com.google.android.gms.tagmanager.ap> m2302t(int r16) {
        /*
        r15 = this;
    ...
    L_0x00aa:
        ...
        r1.m1250F(r4);	 Catch:{ SQLiteException -> 0x0112, all -> 0x0164 }
    L_0x00b8:
        r1 = r3 + 1;
    ...
    L_0x00cc:
        ...
        com.google.android.gms.tagmanager.bh.m1269w(r2);	 Catch:{ all -> 0x016c }
    ...
    L_0x00f4:
        ...
        com.google.android.gms.tagmanager.bh.m1269w(r1);	 Catch:{ SQLiteException -> 0x0112, all -> 0x0164 }
        goto L_0x00b8;
    L_0x0112:
        r1 = move-exception;
        r12 = r2;
    L_0x0114:
        ...
        com.google.android.gms.tagmanager.bh.m1269w(r1);	 Catch:{ all -> 0x015d }

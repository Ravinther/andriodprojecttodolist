...
class cy extends cx {
    ...
    class C03932 implements Callback {
    ...
    class C07831 implements au {
        ...
        public void m2316p(boolean z) {
            this.Xq.m2323a(z, this.Xq.connected);
        }
    }
    ...
    private cy() {
        ...
        this.connected = true;
        this.Xl = true;
        this.Xm = new C07831(this);
        this.Xo = false;
    }

    private void bC() {
        this.Xn = new bn(this);
        this.Xn.m1278o(this.Xf);
    }

    private void bD() {
        this.handler = new Handler(this.Xf.getMainLooper(), new C03932(this));
        if (this.Xi > 0) {
    ...
    synchronized void m2322a(Context context, ar arVar) {
        if (this.Xf == null) {
    ...
    synchronized void m2323a(boolean z, boolean z2) {
        if (!(this.Xo == z && this.connected == z2)) {
            ...
            bh.m1268v(append.append(str).toString());
            this.Xo = z;
            this.connected = z2;
        }
    }
    ...
    public synchronized void bp() {
        if (this.Xk) {
            this.Xh.m1251a(new C03943(this));
        } else {
            bh.m1268v("Dispatch call queued. Dispatch will run once initialization is complete.");
            this.Xj = true;
        }
    }
    ...
    synchronized void m2324q(boolean z) {
        m2323a(this.Xo, z);
    }
}

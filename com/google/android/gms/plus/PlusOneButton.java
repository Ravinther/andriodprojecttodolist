...
import com.google.android.gms.plus.internal.C0356g;
...
public final class PlusOneButton extends FrameLayout {
    ...
    protected static int getAnnotation(Context context, AttributeSet attrs) {
        String a = eu.m729a("http://schemas.android.com/apk/lib/com.google.android.gms.plus", "annotation", context, attrs, true, false, "PlusOneButton");
    ...
    protected static int getSize(Context context, AttributeSet attrs) {
        String a = eu.m729a("http://schemas.android.com/apk/lib/com.google.android.gms.plus", "size", context, attrs, true, false, "PlusOneButton");
    ...
    private void m1177v(Context context) {
        if (this.QV != null) {
            removeView(this.QV);
        }
        this.QV = C0356g.m1205a(context, this.mSize, this.QW, this.pS, this.QX);
        setOnPlusOneClickListener(this.QY);
        addView(this.QV);
    }

    public void initialize(String url, int activityRequestCode) {
        er.m717a(getContext() instanceof Activity, "To use this method, the PlusOneButton must be placed in an Activity. Use initialize(String, OnPlusOneClickListener).");
        this.pS = url;

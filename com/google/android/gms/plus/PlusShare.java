...
public final class PlusShare {
    ...
    public static class Builder {
        ...
        public Builder(Activity launchingActivity, PlusClient plusClient) {
            ...
            er.m717a(plusClient != null, "PlusClient must not be null.");
            er.m717a(plusClient.isConnected(), "PlusClient must be connected to create an interactive post.");
            er.m717a(plusClient.hj().aR(Scopes.PLUS_LOGIN), "Must request PLUS_LOGIN scope in PlusClient to create an interactive post.");
        ...
        public Builder addCallToAction(String label, Uri uri, String deepLinkId) {
            er.m717a(this.Rb, "Must include the launching activity with PlusShare.Builder constructor before setting call-to-action");
            boolean z = (uri == null || TextUtils.isEmpty(uri.toString())) ? false : true;
            er.m720b(z, (Object) "Must provide a call to action URL");
            ...
            if (!TextUtils.isEmpty(deepLinkId)) {
                er.m717a(PlusShare.aO(deepLinkId), "The specified deep-link ID was malformed.");
        ...
        public Intent getIntent() {
            ...
            er.m717a(z3, "Call-to-action buttons are only available for URLs.");
            z3 = !booleanExtra || this.mIntent.hasExtra(PlusShare.EXTRA_CONTENT_URL);
            er.m717a(z3, "The content URL is required for interactive posts.");
            ...
            er.m717a(z, "Must set content URL or content deep-link ID to use a call-to-action button.");
            if (this.mIntent.hasExtra(PlusShare.EXTRA_CONTENT_DEEP_LINK_ID)) {
                er.m717a(PlusShare.aO(this.mIntent.getStringExtra(PlusShare.EXTRA_CONTENT_DEEP_LINK_ID)), "The specified deep-link ID was malformed.");
            }
            if (!z2 && equals) {
        ...
        public Builder setContentDeepLinkId(String deepLinkId, String title, String description, Uri thumbnailUri) {
            er.m720b(this.Rb, (Object) "Must include the launching activity with PlusShare.Builder constructor before setting deep links");
            er.m720b(!TextUtils.isEmpty(deepLinkId), (Object) "The deepLinkId parameter is required.");
            Bundle a = PlusShare.m1178a(title, description, thumbnailUri);
    ...
    public static Bundle m1178a(String str, String str2, Uri uri) {
        Bundle bundle = new Bundle();

...
public interface GoogleApiClient {
    ...
    public static final class Builder {
        ...
        public Builder(Context context, ConnectionCallbacks connectedListener, OnConnectionFailedListener connectionFailedListener) {
            this(context);
            er.m719b((Object) connectedListener, (Object) "Must provide a connected listener");
            this.zt.add(connectedListener);
            er.m719b((Object) connectionFailedListener, (Object) "Must provide a connection failed listener");
        ...
        public GoogleApiClient build() {
            return new C0530b(this.mContext, this.zs, dx(), this.zr, this.zt, this.zu);
        }
        ...
        public Builder setHandler(Handler handler) {
            er.m719b((Object) handler, (Object) "Handler must not be null");
    ...
    <C extends C0131a> C m135a(C0132b<C> c0132b);

    <A extends C0131a, T extends C0526a<? extends Result, A>> T m136a(T t);

    <A extends C0131a, T extends C0526a<? extends Result, A>> T m137b(T t);

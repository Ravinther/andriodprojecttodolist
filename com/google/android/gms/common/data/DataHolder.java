...
public final class DataHolder implements SafeParcelable {
    ...
    public static class Builder {
        ...
        private Builder(String[] columns, String uniqueColumn) {
            this.Aa = (String[]) er.m721f(columns);
        ...
        private void m147a(HashMap<String, Object> hashMap) {
        ...
        public Builder sort(String sortColumn) {
            ...
            if (!(this.Am && sortColumn.equals(this.An))) {
                Collections.sort(this.Aj, new C0140a(sortColumn));
                dJ();
                this.Am = true;
                this.An = sortColumn;
            }
    ...
    private static final class C0140a implements Comparator<HashMap<String, Object>> {
        private final String Ao;

        C0140a(String str) {
            this.Ao = (String) er.m721f(str);
        }

        public int m150a(HashMap<String, Object> hashMap, HashMap<String, Object> hashMap2) {
            Object f = er.m721f(hashMap.get(this.Ao));
            Object f2 = er.m721f(hashMap2.get(this.Ao));
            if (f.equals(f2)) {
                return 0;
            }
        ...
        public /* synthetic */ int compare(Object x0, Object x1) {
            return m150a((HashMap) x0, (HashMap) x1);
        }
    }

    /* renamed from: com.google.android.gms.common.data.DataHolder.1 */
    static class C05311 extends Builder {
        C05311(String[] strArr, String str) {
            super(str, null);
        }
    ...
    static {
        ...
        Ai = new C05311(new String[0], null);
    }
    ...
    public DataHolder(AbstractWindowedCursor cursor, int statusCode, Bundle metadata) {
        this(cursor.getColumnNames(), m1551a(cursor), statusCode, metadata);
    }

    private DataHolder(Builder builder, int statusCode, Bundle metadata) {
        this(builder.Aa, m1552a(builder, -1), statusCode, metadata);
    }

    private DataHolder(Builder builder, int statusCode, Bundle metadata, int maxResults) {
        this(builder.Aa, m1552a(builder, maxResults), statusCode, metadata);
    }
    ...
    public DataHolder(String[] columns, CursorWindow[] windows, int statusCode, Bundle metadata) {
        ...
        this.wj = 1;
        this.Aa = (String[]) er.m721f(columns);
        this.Ac = (CursorWindow[]) er.m721f(windows);
        this.yJ = statusCode;
        this.Ad = metadata;
        validateContents();
    }

    private static CursorWindow[] m1551a(AbstractWindowedCursor abstractWindowedCursor) {
        int i;
    ...
    private static CursorWindow[] m1552a(Builder builder, int i) {
        int size;
        int i2 = 0;
    ...
    public static Builder builder(String[] columns, String uniqueColumn) {
        er.m721f(uniqueColumn);
        return new Builder(uniqueColumn, null);
    }

    private void m1553e(String str, int i) {
    ...
    public void writeToParcel(Parcel dest, int flags) {
        DataHolderCreator.m151a(this, dest, flags);
    }
}

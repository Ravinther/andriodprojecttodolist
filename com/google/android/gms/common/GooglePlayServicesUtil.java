...
public final class GooglePlayServicesUtil {
    ...
    private static int m118F(int i) {
        return i == -1 ? 2 : i;
    }

    private static byte[] m119Z(String str) {
        try {
    ...
    public static Dialog m120a(int i, Activity activity, int i2, OnCancelListener onCancelListener, int i3) {
        Builder message = new Builder(activity).setMessage(m126b(activity, i, i3));
        if (onCancelListener != null) {
            message.setOnCancelListener(onCancelListener);
        }
        OnClickListener efVar = new ef(activity, m121a(activity, i, i3), i2);
        CharSequence b = m125b(activity, i);
        if (b != null) {
        ...
        switch (i) {
            case DragSortController.ON_DOWN /*0*/:
                return null;
            case Value.TYPE_FIELD_NUMBER /*1*/:
                return message.setTitle(C0083R.string.common_google_play_services_install_title).create();
            case Value.STRING_FIELD_NUMBER /*2*/:
                return message.setTitle(C0083R.string.common_google_play_services_update_title).create();
            case Value.LIST_ITEM_FIELD_NUMBER /*3*/:
                return message.setTitle(C0083R.string.common_google_play_services_enable_title).create();
            case Value.MAP_KEY_FIELD_NUMBER /*4*/:
            case Value.MACRO_REFERENCE_FIELD_NUMBER /*6*/:
                return message.create();
            case Value.MAP_VALUE_FIELD_NUMBER /*5*/:
                Log.e("GooglePlayServicesUtil", "An invalid account was specified when connecting. Please provide a valid account.");
                return message.setTitle(C0083R.string.common_google_play_services_invalid_account_title).create();
            case Value.FUNCTION_ID_FIELD_NUMBER /*7*/:
                Log.e("GooglePlayServicesUtil", "Network error occurred. Please retry request later.");
                return message.setTitle(C0083R.string.common_google_play_services_network_error_title).create();
            case Value.INTEGER_FIELD_NUMBER /*8*/:
                Log.e("GooglePlayServicesUtil", "Internal error occurred. Please see logs for detailed information");
                return message.create();
            case Value.CONTAINS_REFERENCES_FIELD_NUMBER /*9*/:
                Log.e("GooglePlayServicesUtil", "Google Play services is invalid. Cannot recover.");
                return message.setTitle(C0083R.string.common_google_play_services_unsupported_title).create();
    ...
    public static Intent m121a(Context context, int i, int i2) {
        switch (i) {
            case Value.TYPE_FIELD_NUMBER /*1*/:
            case Value.STRING_FIELD_NUMBER /*2*/:
                return m117E(i2) ? m131u(context) ? ek.ai(GOOGLE_PLAY_SERVICES_PACKAGE) : ek.ah("com.google.android.apps.bazaar") : ek.ah(GOOGLE_PLAY_SERVICES_PACKAGE);
            case Value.LIST_ITEM_FIELD_NUMBER /*3*/:
    ...
    public static boolean m122a(Resources resources) {
        if (resources == null) {
            return false;
        }
        return (fr.eJ() && ((resources.getConfiguration().screenLayout & 15) > 3)) || m127b(resources);
    }

    private static byte[] m123a(PackageInfo packageInfo, byte[]... bArr) {
        try {
    ...
    private static byte[][] m124a(byte[][]... bArr) {
        int i = 0;
    ...
    public static String m125b(Context context, int i) {
    ...
    public static String m126b(Context context, int i, int i2) {
        Resources resources = context.getResources();
        String string;
        switch (i) {
            case Value.TYPE_FIELD_NUMBER /*1*/:
                string = m122a(context.getResources()) ? resources.getString(C0083R.string.common_google_play_services_install_text_tablet) : resources.getString(C0083R.string.common_google_play_services_install_text_phone);
                return m117E(i2) ? string + " (via Bazaar)" : string;
            case Value.STRING_FIELD_NUMBER /*2*/:
                string = resources.getString(C0083R.string.common_google_play_services_update_text);
                return m117E(i2) ? string + " (via Bazaar)" : string;
            case Value.LIST_ITEM_FIELD_NUMBER /*3*/:
                return resources.getString(C0083R.string.common_google_play_services_enable_text);
            case Value.MAP_VALUE_FIELD_NUMBER /*5*/:
                return resources.getString(C0083R.string.common_google_play_services_invalid_account_text);
            case Value.FUNCTION_ID_FIELD_NUMBER /*7*/:
                return resources.getString(C0083R.string.common_google_play_services_network_error_text);
            case Value.CONTAINS_REFERENCES_FIELD_NUMBER /*9*/:
                return resources.getString(C0083R.string.common_google_play_services_unsupported_text);
            case Value.BOOLEAN_FIELD_NUMBER /*12*/:
                return resources.getString(C0083R.string.common_google_play_services_unsupported_date_text);
            default:
                return resources.getString(C0083R.string.common_google_play_services_unknown_issue);
        }
    }

    private static boolean m127b(Resources resources) {
        Configuration configuration = resources.getConfiguration();
        return fr.eL() && (configuration.screenLayout & 15) <= 3 && configuration.smallestScreenWidthDp >= 600;
    }

    public static boolean m128do() {
        return yS ? yT : "user".equals(Build.TYPE);
    }

    public static Dialog getErrorDialog(int errorCode, Activity activity, int requestCode) {
        return m120a(errorCode, activity, requestCode, null, -1);
    }

    public static Dialog getErrorDialog(int errorCode, Activity activity, int requestCode, OnCancelListener cancelListener) {
        return m120a(errorCode, activity, requestCode, cancelListener, -1);
    }

    public static PendingIntent getErrorPendingIntent(int errorCode, Context context, int requestCode) {
        Intent a = m121a(context, errorCode, -1);
    ...
    public static int isGooglePlayServicesAvailable(Context context) {
        ...
        try {
            ...
            try {
                if (m123a(packageManager.getPackageInfo(GOOGLE_PLAY_STORE_PACKAGE, 64), yL) == null) {
                    Log.w("GooglePlayServicesUtil", "Google Play Store signature invalid.");
                    return 9;
                }
                if (m123a(packageInfo, m123a(packageManager.getPackageInfo(GOOGLE_PLAY_STORE_PACKAGE, 64), yL)) == null) {
    ...
    public static void m129s(Context context) throws GooglePlayServicesRepairableException, GooglePlayServicesNotAvailableException {
        int isGooglePlayServicesAvailable = isGooglePlayServicesAvailable(context);
        if (isGooglePlayServicesAvailable != 0) {
            Intent a = m121a(context, isGooglePlayServicesAvailable, -1);
    ...
    public static boolean showErrorDialogFragment(int errorCode, Activity activity, int requestCode, OnCancelListener cancelListener) {
        ...
        if (z) {
            C0863b.m2411a(errorDialog, cancelListener).show(((FragmentActivity) activity).getSupportFragmentManager(), GMS_ERROR_DIALOG);
        } else if (fr.eJ()) {
    ...
    private static void m130t(Context context) {
    ...
    private static boolean m131u(Context context) {
        if (yS) {
            return yU;
        }
        try {
            return m123a(context.getPackageManager().getPackageInfo("com.google.android.apps.bazaar", 64), yR) != null;
        } catch (NameNotFoundException e) {
            return false;
        }
    }

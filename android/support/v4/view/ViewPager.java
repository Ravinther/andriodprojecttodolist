...
public class ViewPager extends ViewGroup {
    ...
    static class C00311 implements Comparator<ItemInfo> {
        C00311() {
        }
    ...
    static class C00322 implements Interpolator {
        C00322() {
        }
    ...
    public static class SavedState extends BaseSavedState {
        ...
        static class C04751 implements ParcelableCompatCreatorCallbacks<SavedState> {
            C04751() {
            }
        ...
        static {
            CREATOR = ParcelableCompat.newCreator(new C04751());
        }
    ...
    class MyAccessibilityDelegate extends AccessibilityDelegateCompat {
        ...
        public void onInitializeAccessibilityEvent(View host, AccessibilityEvent event) {
            ...
            if (event.getEventType() == CodedOutputStream.DEFAULT_BUFFER_SIZE && ViewPager.this.mAdapter != null) {
        ...
        public void onInitializeAccessibilityNodeInfo(View host, AccessibilityNodeInfoCompat info) {
            ...
            if (ViewPager.this.canScrollHorizontally(ViewPager.SCROLL_STATE_DRAGGING)) {
                info.addAction(CodedOutputStream.DEFAULT_BUFFER_SIZE);
            }
    ...
    static {
        ...
        LAYOUT_ATTRS = iArr;
        COMPARATOR = new C00311();
        sInterpolator = new C00322();
    ...
    public ViewPager(Context context) {
        ...
        this.mEndScrollRunnable = new C00333();
    ...
    public boolean dispatchPopulateAccessibilityEvent(AccessibilityEvent event) {
        if (event.getEventType() == CodedOutputStream.DEFAULT_BUFFER_SIZE) {

...
class TransportMediatorJellybeanMR2 implements OnGetPlaybackPositionListener, OnPlaybackPositionUpdateListener {
    ...
    class C00121 implements OnWindowAttachListener {
        C00121() {
        }
    ...
    class C00132 implements OnWindowFocusChangeListener {
        C00132() {
        }
    ...
    class C00143 extends BroadcastReceiver {
        C00143() {
        }
    ...
    class C00154 implements OnAudioFocusChangeListener {
        C00154() {
        }
    ...
    public TransportMediatorJellybeanMR2(Context context, AudioManager audioManager, View view, TransportMediatorCallback transportCallback) {
        this.mWindowAttachListener = new C00121();
        this.mWindowFocusListener = new C00132();
        this.mMediaButtonReceiver = new C00143();
        this.mAudioFocusChangeListener = new C00154();
        this.mPlayState = 0;

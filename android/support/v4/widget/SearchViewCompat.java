...
public class SearchViewCompat {
    ...
    static class SearchViewCompatHoneycombImpl extends SearchViewCompatStubImpl {
        ...
        class C04791 implements OnQueryTextListenerCompatBridge {
            final /* synthetic */ OnQueryTextListenerCompat val$listener;

            C04791(OnQueryTextListenerCompat onQueryTextListenerCompat) {
        ...
        class C04802 implements OnCloseListenerCompatBridge {
            final /* synthetic */ OnCloseListenerCompat val$listener;

            C04802(OnCloseListenerCompat onCloseListenerCompat) {
        ...
        public Object newOnQueryTextListener(OnQueryTextListenerCompat listener) {
            return SearchViewCompatHoneycomb.newOnQueryTextListener(new C04791(listener));
        }
        ...
        public Object newOnCloseListener(OnCloseListenerCompat listener) {
            return SearchViewCompatHoneycomb.newOnCloseListener(new C04802(listener));
        }

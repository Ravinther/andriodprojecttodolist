...
public class SwipeRefreshLayout extends ViewGroup {
    ...
    class C00481 extends Animation {
        C00481() {
        }
    ...
    class C00492 extends Animation {
        C00492() {
        }
    ...
    class C00516 implements Runnable {
        C00516() {
        }
    ...
    class C04813 extends BaseAnimationListener {
        C04813() {
            super(null);
        }
    ...
    class C04824 extends BaseAnimationListener {
        C04824() {
            super(null);
        }
    ...
    public SwipeRefreshLayout(Context context, AttributeSet attrs) {
        ...
        this.mAnimateToStartPosition = new C00481();
        this.mShrinkTrigger = new C00492();
        this.mReturnToStartPositionListener = new C04813();
        this.mShrinkAnimationListener = new C04824();
        this.mReturnToStartPosition = new C00505();
        this.mCancel = new C00516();
